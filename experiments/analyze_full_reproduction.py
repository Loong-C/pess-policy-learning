...
def _figure_summary(
    ...
    return {
        ...
        "coverage_rate": len(comparison) / reference_cells,
        "coverage_complete": len(comparison) == reference_cells,
        ...
        summaries.append(
            {
                ...
                "ours_cells": len(raw),
                "coverage_rate": len(comparison) / len(reference),
                "coverage_complete": len(comparison) == len(reference),
